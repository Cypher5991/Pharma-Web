        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-8 flex-1">
          ...
          <div className="bg-blue-50/70 p-5 rounded-2xl border border-blue-200/80 space-y-2">
            <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-blue-900">
              ...
              <span>Target Site: PharmaTech vs. Benchmarks (Recipharm, Cohance, CPL)</span>
            </div>
            <p className="text-xs sm:text-sm text-blue-950 leading-relaxed">
              <strong>Option A Execution Summary:</strong> Transformed PharmaTech’s digital presence from a standard brochure catalog into a high-converting <strong>CDMO Commercial Engine</strong>. 
          ...
          <div className="space-y-3">
            ...
            <div className="border border-slate-200 rounded-2xl overflow-hidden text-xs">
              ...
              {[
                ...
                {
                  pillar: '2. Technical Authority',
                  prev: 'Generic claims without audit-grade compliance documentation.',
                  solution: 'Prominent WHO-GMP, cGMP Schedule M & ISO validation badges with full regulatory dossier disclosures.'
                },
                {
                  pillar: '3. Lead Generation (CRO)',
                  prev: 'Standard generic contact form with long response cycles.',
                  solution: '2-step Quick Technical RFP Drawer with instant dosage modality & packaging selection.'
                },
                {
                  pillar: '4. Visual Hierarchy',
                  prev: 'Dense typography with inconsistent mobile responsive breaks.',
                  solution: 'Clean typography (Plus Jakarta Sans + Outfit), high-contrast data callouts, and spacious card layouts.'
                },
                {
                  pillar: '5. CDMO Positioning',
                  prev: 'Looked like a retail pharma website rather than a B2B manufacturer.',
                  solution: 'Enterprise CDMO tone, highlighting 1.4B+ monthly scale, automated compression lines, and B2B engagement models.'
                }
              ].map((row, idx) => (
                <div key={idx} className="grid grid-cols-12 p-3 border-b border-slate-200/60 last:border-0 hover:bg-slate-50 transition-colors">
                  <div className="col-span-3 font-bold text-slate-900">{row.pillar}</div>
                  <div className="col-span-4 text-slate-500 pr-2">{row.prev}</div>
                  <div className="col-span-5 text-blue-900 font-medium pl-1">{row.solution}</div>
                </div>
              ))}
            </div>
          </div>

          {/* CRO Quick Wins Implemented */}
          <div className="space-y-3">
            <h4 className="text-base font-bold text-slate-900 font-['Outfit',sans-serif]">
              2. High-Impact Enhancements Implemented
            </h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 space-y-2">
                ...
                <ul className="text-[11px] text-blue-950 space-y-1">
                  ...
                  <li>✓ "Why PharmaTech" Operational Pillars</li>
                </ul>
              </div>
